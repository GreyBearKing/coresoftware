...
*/
SvtxTrackArray_v3::SvtxTrackArray_v3(){
// always include the pca point
  //_states.insert( std::make_pair(0, new SvtxTrackState_v1(0)));
}

SvtxTrackArray_v3::SvtxTrackArray_v3(const SvtxTrackArray& source)
{ SvtxTrackArray_v3::CopyFrom( source ); }

// have to suppress uninitMenberVar from cppcheck since it triggers many false positive
// cppcheck-suppress uninitMemberVar
SvtxTrackArray_v3::SvtxTrackArray_v3(const SvtxTrackArray_v3& source)
{ SvtxTrackArray_v3::CopyFrom( source ); }

SvtxTrackArray_v3& SvtxTrackArray_v3::operator=(const SvtxTrackArray_v3& source)
{ CopyFrom( source ); return *this; }

//IMPROVE
void SvtxTrackArray_v3::CopyFrom( const SvtxTrackArray& source )
{
...
void SvtxTrackArray_v3::identify(std::ostream& os) const
{
    os << "SvtxTrackArray_v3 Object " << std::endl;
...
*/
int SvtxTrackArray_v3::isValid() const
{
  return 1;
}
