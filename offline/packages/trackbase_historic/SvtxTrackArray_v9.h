#ifndef TRACKBASEHISTORIC_SVTXTRACKARRAYV9_H
#define TRACKBASEHISTORIC_SVTXTRACKARRAYV9_H
...
class SvtxTrackArray_v9 : public SvtxTrackArray
{
 public:
  SvtxTrackArray_v9();
  SvtxTrackArray_v9(const SvtxTrackArray& trackarray);
  SvtxTrackArray_v9(const SvtxTrackArray_v9& trackarray);
  SvtxTrackArray_v9& operator=(const SvtxTrackArray_v9& trackarray);
  ~SvtxTrackArray_v9() override;

  void identify(std::ostream& os = std::cout) const override;
  void Reset() override { *this = SvtxTrackArray_v9();}
  int isValid() const override;
  PHObject* CloneMe() const override { return new SvtxTrackArray_v9(*this); }
...
*/
 ...
 private:
  ...
  //track seeds are currently members of SvtxTrack_v9
...
*/
  ...
  */
  ...
  ClassDefOverride(SvtxTrackArray_v9, 1);
};
