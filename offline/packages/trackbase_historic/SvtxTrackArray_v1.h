#ifndef TRACKBASEHISTORIC_SVTXTRACKARRAYV1_H
#define TRACKBASEHISTORIC_SVTXTRACKARRAYV1_H
...
class SvtxTrackArray_v1 : public SvtxTrackArray
{
 public:
  SvtxTrackArray_v1();
  SvtxTrackArray_v1(const SvtxTrackArray& trackarray);
  SvtxTrackArray_v1(const SvtxTrackArray_v1& trackarray);
  SvtxTrackArray_v1& operator=(const SvtxTrackArray_v1& trackarray);
  ~SvtxTrackArray_v1() override;

  void identify(std::ostream& os = std::cout) const override;
  void Reset() override { *this = SvtxTrackArray_v1();}
  int isValid() const override;
  PHObject* CloneMe() const override { return new SvtxTrackArray_v1(*this); }
...
/* currently get rid of states
  ...
  void copy_states(SvtxTrack* source) override{
 ...
 private:
  ...
  ClassDefOverride(SvtxTrackArray_v1, 1);
};
