#ifndef TRACKBASEHISTORIC_SVTXTRACKARRAYV6_H
#define TRACKBASEHISTORIC_SVTXTRACKARRAYV6_H
...
class SvtxTrackArray_v6 : public SvtxTrackArray
{
 public:
  SvtxTrackArray_v6();
  SvtxTrackArray_v6(const SvtxTrackArray& trackarray);
  SvtxTrackArray_v6(const SvtxTrackArray_v6& trackarray);
  SvtxTrackArray_v6& operator=(const SvtxTrackArray_v6& trackarray);
  ~SvtxTrackArray_v6() override;

  void identify(std::ostream& os = std::cout) const override;
  void Reset() override { *this = SvtxTrackArray_v6();}
  int isValid() const override;
  PHObject* CloneMe() const override { return new SvtxTrackArray_v6(*this); }
...
*/
 ...
 private:
  ...
  //track seeds are currently members of SvtxTrack_v6
...
*/
  ...
  */
  ...
  ClassDefOverride(SvtxTrackArray_v6, 1);
};
