#ifndef TRACKBASEHISTORIC_SVTXTRACKARRAYV8_H
#define TRACKBASEHISTORIC_SVTXTRACKARRAYV8_H
...
class SvtxTrackArray_v8 : public SvtxTrackArray
{
 public:
  SvtxTrackArray_v8();
  SvtxTrackArray_v8(const SvtxTrackArray& trackarray);
  SvtxTrackArray_v8(const SvtxTrackArray_v8& trackarray);
  SvtxTrackArray_v8& operator=(const SvtxTrackArray_v8& trackarray);
  ~SvtxTrackArray_v8() override;

  void identify(std::ostream& os = std::cout) const override;
  void Reset() override { *this = SvtxTrackArray_v8();}
  int isValid() const override;
  PHObject* CloneMe() const override { return new SvtxTrackArray_v8(*this); }
...
*/
 ...
 private:
  ...
  //track seeds are currently members of SvtxTrack_v8
...
*/
  ...
  */
  ...
  //struct cluster_with_sector_side_residuals_minimum cluster_residuals_array[48];
    uint8_t m_x_residual[48];
    uint8_t m_y_residual[48];
    //uint8_t m_adc_information_flags[48];
    //uint8_t m_flags[48];

  ClassDefOverride(SvtxTrackArray_v8, 1);
};
