...
*/
SvtxTrackArray_v7::SvtxTrackArray_v7(){
// always include the pca point
  //_states.insert( std::make_pair(0, new SvtxTrackState_v1(0)));
}

SvtxTrackArray_v7::SvtxTrackArray_v7(const SvtxTrackArray& source)
{ SvtxTrackArray_v7::CopyFrom( source ); }

// have to suppress uninitMenberVar from cppcheck since it triggers many false positive
// cppcheck-suppress uninitMemberVar
SvtxTrackArray_v7::SvtxTrackArray_v7(const SvtxTrackArray_v7& source)
{ SvtxTrackArray_v7::CopyFrom( source ); }

SvtxTrackArray_v7& SvtxTrackArray_v7::operator=(const SvtxTrackArray_v7& source)
{ CopyFrom( source ); return *this; }

//IMPROVE
void SvtxTrackArray_v7::CopyFrom( const SvtxTrackArray& source )
{
...
void SvtxTrackArray_v7::identify(std::ostream& os) const
{
    os << "SvtxTrackArray_v7 Object " << std::endl;
...
*/
int SvtxTrackArray_v7::isValid() const
{
  return 1;
}
...
/*
void SvtxTrackArray_v1::addTrack(SvtxTrack_v7 &track, unsigned int key, int index){
    //SvtxTrack_v7* tmpTrack = TrackArray->ConstructedAt(index);
    TrackArray[index]= new SvtxTrack_v7(track);
...
SvtxTrack_v7* SvtxTrackArray_v1::findTrack(unsigned int key){
