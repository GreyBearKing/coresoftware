...
*/
SvtxTrackArray_v2::SvtxTrackArray_v2(){
// always include the pca point
  //_states.insert( std::make_pair(0, new SvtxTrackState_v1(0)));
}

SvtxTrackArray_v2::SvtxTrackArray_v2(const SvtxTrackArray& source)
{ SvtxTrackArray_v2::CopyFrom( source ); }

// have to suppress uninitMenberVar from cppcheck since it triggers many false positive
// cppcheck-suppress uninitMemberVar
SvtxTrackArray_v2::SvtxTrackArray_v2(const SvtxTrackArray_v2& source)
{ SvtxTrackArray_v2::CopyFrom( source ); }

SvtxTrackArray_v2& SvtxTrackArray_v2::operator=(const SvtxTrackArray_v2& source)
{ CopyFrom( source ); return *this; }

//IMPROVE
void SvtxTrackArray_v2::CopyFrom( const SvtxTrackArray& source )
{
  ...
  for(int i = 0; i<50; i++){
    ...
    if(source.getValid(i)){
        ...
        setLocalYKeyResiduals(i, source.getLocalYKeyResiduals(i));
...
void SvtxTrackArray_v2::identify(std::ostream& os) const
{
    os << "SvtxTrackArray_v2 Object " << std::endl;
...
*/
int SvtxTrackArray_v2::isValid() const
{
  return 1;
}
