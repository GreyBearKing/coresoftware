...
*/
SvtxTrackArray_v8::SvtxTrackArray_v8(){
// always include the pca point
  //_states.insert( std::make_pair(0, new SvtxTrackState_v1(0)));
}

SvtxTrackArray_v8::SvtxTrackArray_v8(const SvtxTrackArray& source)
{ SvtxTrackArray_v8::CopyFrom( source ); }

// have to suppress uninitMenberVar from cppcheck since it triggers many false positive
// cppcheck-suppress uninitMemberVar
SvtxTrackArray_v8::SvtxTrackArray_v8(const SvtxTrackArray_v8& source)
{ SvtxTrackArray_v8::CopyFrom( source ); }

SvtxTrackArray_v8& SvtxTrackArray_v8::operator=(const SvtxTrackArray_v8& source)
{ CopyFrom( source ); return *this; }

//IMPROVE
void SvtxTrackArray_v8::CopyFrom( const SvtxTrackArray& source )
{
...
void SvtxTrackArray_v8::identify(std::ostream& os) const
{
    os << "SvtxTrackArray_v8 Object " << std::endl;
...
*/
int SvtxTrackArray_v8::isValid() const
{
  return 1;
}
...
/*
void SvtxTrackArray_v1::addTrack(SvtxTrack_v8 &track, unsigned int key, int index){
    //SvtxTrack_v8* tmpTrack = TrackArray->ConstructedAt(index);
    TrackArray[index]= new SvtxTrack_v8(track);
...
SvtxTrack_v8* SvtxTrackArray_v1::findTrack(unsigned int key){
