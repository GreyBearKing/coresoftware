...
*/
SvtxTrackArray_v4::SvtxTrackArray_v4(){
// always include the pca point
  //_states.insert( std::make_pair(0, new SvtxTrackState_v1(0)));
}

SvtxTrackArray_v4::SvtxTrackArray_v4(const SvtxTrackArray& source)
{ SvtxTrackArray_v4::CopyFrom( source ); }

// have to suppress uninitMenberVar from cppcheck since it triggers many false positive
// cppcheck-suppress uninitMemberVar
SvtxTrackArray_v4::SvtxTrackArray_v4(const SvtxTrackArray_v4& source)
{ SvtxTrackArray_v4::CopyFrom( source ); }

SvtxTrackArray_v4& SvtxTrackArray_v4::operator=(const SvtxTrackArray_v4& source)
{ CopyFrom( source ); return *this; }

//IMPROVE
void SvtxTrackArray_v4::CopyFrom( const SvtxTrackArray& source )
{
...
void SvtxTrackArray_v4::identify(std::ostream& os) const
{
    os << "SvtxTrackArray_v4 Object " << std::endl;
...
*/
int SvtxTrackArray_v4::isValid() const
{
  return 1;
}
