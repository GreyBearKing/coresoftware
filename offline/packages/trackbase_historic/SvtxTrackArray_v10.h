#ifndef TRACKBASEHISTORIC_SVTXTRACKARRAYV10_H
#define TRACKBASEHISTORIC_SVTXTRACKARRAYV10_H
...
class SvtxTrackArray_v10 : public SvtxTrackArray
{
 public:
  SvtxTrackArray_v10();
  SvtxTrackArray_v10(const SvtxTrackArray& trackarray);
  SvtxTrackArray_v10(const SvtxTrackArray_v10& trackarray);
  SvtxTrackArray_v10& operator=(const SvtxTrackArray_v10& trackarray);
  ~SvtxTrackArray_v10() override;

  void identify(std::ostream& os = std::cout) const override;
  void Reset() override { *this = SvtxTrackArray_v10();}
  int isValid() const override;
  PHObject* CloneMe() const override { return new SvtxTrackArray_v10(*this); }
...
*/
  ...
  //uint8_t getMinimumLocalXKeyResiduals(int struct_index) const override { return m_x_residual[struct_index]; }
  //void setMinimumLocalXKeyResiduals(int struct_index, uint8_t loc0) override { m_x_residual[struct_index] = loc0; }
  //uint8_t getMinimumLocalYKeyResiduals(int struct_index) const override { return m_y_residual[struct_index]; }
  //void setMinimumLocalYKeyResiduals(int struct_index, uint8_t loc1) override { m_y_residual[struct_index] = loc1; }

  /*
  float getLocalX(int struct_index) const override { return m_x_float[struct_index]; }
  void setLocalX(int struct_index, float loc0) override { m_x_float[struct_index] = loc0; }
  float getLocalY(int struct_index) const override { return m_y_float[struct_index]; }
  void setLocalY(int struct_index, float loc1) override {m_y_float[struct_index] = loc1; }
*/

  short getLocalXInt(int struct_index) const override { return m_x_int[struct_index]; }
  void setLocalXInt(int struct_index, short loc0) override { m_x_int[struct_index] = loc0; }
  short getLocalYInt(int struct_index) const override { return m_y_int[struct_index]; }
  void setLocalYInt(int struct_index, short loc1) override {m_y_int[struct_index] = loc1; }


  //new adc info
  /*
  uint8_t getAdcInfoResidualsAndFlags(int struct_index) const override { 
    return m_adc_information_flags[struct_index]; 
  }

  void setAdcInfoResidualsAndFlags(int struct_index, uint8_t adcinfo) override {
    m_adc_information_flags[struct_index] = adcinfo;
  }
  */
...
*/
 ...
 private:
  ...
  //track seeds are currently members of SvtxTrack_v10
...
*/
  ...
  //information from SvtxTrack_v10
  // track information
  ...
  */
  ...
  //struct cluster_with_sector_side_residuals_minimum cluster_residuals_array[48];
    short m_x_int[48];
    short m_y_int[48];
    //uint8_t m_adc_information_flags[48];
    //uint8_t m_flags[48];

  ClassDefOverride(SvtxTrackArray_v10, 1);
};
