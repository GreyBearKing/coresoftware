...
#include "SvtxTrackArrayContainer_v4.h"
...
#include <map>
    ...
    SvtxTrackArrayContainer_v4::SvtxTrackArrayContainer_v4() {


    _clones = new TClonesArray("SvtxTrackArray_v4");

    _clones->SetOwner();
    _clones->SetName("SvtxTrackArrayContainer_v4");
    ...
    void SvtxTrackArrayContainer_v4::identify(std::ostream& os) const{
      os << "SvtxTrackArrayContainer_v4 of size " << size() << std::endl;
    }

    void SvtxTrackArrayContainer_v4::Reset()
  {
