#ifndef TRACKBASEHISTORIC_SVTXTRACKARRAYV3_H
#define TRACKBASEHISTORIC_SVTXTRACKARRAYV3_H
...
class SvtxTrackArray_v3 : public SvtxTrackArray
{
 public:
  SvtxTrackArray_v3();
  SvtxTrackArray_v3(const SvtxTrackArray& trackarray);
  SvtxTrackArray_v3(const SvtxTrackArray_v3& trackarray);
  SvtxTrackArray_v3& operator=(const SvtxTrackArray_v3& trackarray);
  ~SvtxTrackArray_v3() override;

  void identify(std::ostream& os = std::cout) const override;
  void Reset() override { *this = SvtxTrackArray_v3();}
  int isValid() const override;
  PHObject* CloneMe() const override { return new SvtxTrackArray_v3(*this); }
...
*/
  ...
  */
  ...
  struct cluster_with_sector_side_residuals_minimum cluster_residuals_array[50];
  

  ClassDefOverride(SvtxTrackArray_v3, 1);
};
