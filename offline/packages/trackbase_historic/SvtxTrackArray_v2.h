#ifndef TRACKBASEHISTORIC_SVTXTRACKARRAYV2_H
#define TRACKBASEHISTORIC_SVTXTRACKARRAYV2_H
...
class SvtxTrackArray_v2 : public SvtxTrackArray
{
 public:
  SvtxTrackArray_v2();
  SvtxTrackArray_v2(const SvtxTrackArray& trackarray);
  SvtxTrackArray_v2(const SvtxTrackArray_v2& trackarray);
  SvtxTrackArray_v2& operator=(const SvtxTrackArray_v2& trackarray);
  ~SvtxTrackArray_v2() override;

  void identify(std::ostream& os = std::cout) const override;
  void Reset() override { *this = SvtxTrackArray_v2();}
  int isValid() const override;
  PHObject* CloneMe() const override { return new SvtxTrackArray_v2(*this); }
...
*/
  ...
  uint8_t getSideResiduals(int struct_index) const override { return cluster_residuals_array[struct_index].m_side; }
  void setSideResiduals(int struct_index, uint8_t side) override { cluster_residuals_array[struct_index].m_side = side; }

  uint8_t getSectorIdResiduals(int struct_index) const override { return cluster_residuals_array[struct_index].m_sector_id; }
  void setSectorIdResiduals(int struct_index, uint8_t sector_id) override { cluster_residuals_array[struct_index].m_sector_id = sector_id; }

  bool getValidResiduals(int struct_index) const override { return cluster_residuals_array[struct_index].m_valid; }
  void setValidResiduals(int struct_index, bool valid) override { cluster_residuals_array[struct_index].m_valid = valid; }
  ...
  void setAdcResiduals(int struct_index, unsigned int adc) override {
    cluster_residuals_array[struct_index].m_adc = adc; 
  }

  unsigned int getMaxAdcResiduals(int struct_index) const override { 
    return cluster_residuals_array[struct_index].m_maxadc; 
  }

  void setMaxAdcResiduals(int struct_index, uint16_t maxadc) override {
    cluster_residuals_array[struct_index].m_maxadc = maxadc;
  }
 ...
 private:
  ...
  struct cluster_with_sector_side_residuals cluster_residuals_array[50];
  

  ClassDefOverride(SvtxTrackArray_v2, 1);
};
