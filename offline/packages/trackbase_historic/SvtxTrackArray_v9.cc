...
*/
SvtxTrackArray_v9::SvtxTrackArray_v9(){
// always include the pca point
  //_states.insert( std::make_pair(0, new SvtxTrackState_v1(0)));
}

SvtxTrackArray_v9::SvtxTrackArray_v9(const SvtxTrackArray& source)
{ SvtxTrackArray_v9::CopyFrom( source ); }

// have to suppress uninitMenberVar from cppcheck since it triggers many false positive
// cppcheck-suppress uninitMemberVar
SvtxTrackArray_v9::SvtxTrackArray_v9(const SvtxTrackArray_v9& source)
{ SvtxTrackArray_v9::CopyFrom( source ); }

SvtxTrackArray_v9& SvtxTrackArray_v9::operator=(const SvtxTrackArray_v9& source)
{ CopyFrom( source ); return *this; }

//IMPROVE
void SvtxTrackArray_v9::CopyFrom( const SvtxTrackArray& source )
{
...
void SvtxTrackArray_v9::identify(std::ostream& os) const
{
    os << "SvtxTrackArray_v9 Object " << std::endl;
...
*/
int SvtxTrackArray_v9::isValid() const
{
  return 1;
}
...
/*
void SvtxTrackArray_v1::addTrack(SvtxTrack_v9 &track, unsigned int key, int index){
    //SvtxTrack_v9* tmpTrack = TrackArray->ConstructedAt(index);
    TrackArray[index]= new SvtxTrack_v9(track);
...
SvtxTrack_v9* SvtxTrackArray_v1::findTrack(unsigned int key){
