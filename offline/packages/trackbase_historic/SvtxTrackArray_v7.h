#ifndef TRACKBASEHISTORIC_SVTXTRACKARRAYV7_H
#define TRACKBASEHISTORIC_SVTXTRACKARRAYV7_H
...
class SvtxTrackArray_v7 : public SvtxTrackArray
{
 public:
  SvtxTrackArray_v7();
  SvtxTrackArray_v7(const SvtxTrackArray& trackarray);
  SvtxTrackArray_v7(const SvtxTrackArray_v7& trackarray);
  SvtxTrackArray_v7& operator=(const SvtxTrackArray_v7& trackarray);
  ~SvtxTrackArray_v7() override;

  void identify(std::ostream& os = std::cout) const override;
  void Reset() override { *this = SvtxTrackArray_v7();}
  int isValid() const override;
  PHObject* CloneMe() const override { return new SvtxTrackArray_v7(*this); }
...
*/
 ...
 private:
  ...
  //track seeds are currently members of SvtxTrack_v7
...
*/
  ...
  */
  ...
  ClassDefOverride(SvtxTrackArray_v7, 1);
};
