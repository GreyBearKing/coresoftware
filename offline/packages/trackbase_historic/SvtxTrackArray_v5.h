#ifndef TRACKBASEHISTORIC_SVTXTRACKARRAYV5_H
#define TRACKBASEHISTORIC_SVTXTRACKARRAYV5_H
...
class SvtxTrackArray_v5 : public SvtxTrackArray
{
 public:
  SvtxTrackArray_v5();
  SvtxTrackArray_v5(const SvtxTrackArray& trackarray);
  SvtxTrackArray_v5(const SvtxTrackArray_v5& trackarray);
  SvtxTrackArray_v5& operator=(const SvtxTrackArray_v5& trackarray);
  ~SvtxTrackArray_v5() override;

  void identify(std::ostream& os = std::cout) const override;
  void Reset() override { *this = SvtxTrackArray_v5();}
  int isValid() const override;
  PHObject* CloneMe() const override { return new SvtxTrackArray_v5(*this); }
...
*/
  ...
  uint8_t getAdcInfoResiduals(int struct_index) const override { 
    return m_adc_information[struct_index]; 
  }

  void setAdcInfoResiduals(int struct_index, uint8_t adcinfo) override {
    m_adc_information[struct_index] = adcinfo;
  }
...
*/
 ...
 private:
  ...
  //track seeds are currently members of SvtxTrack_v5
...
*/
  ...
  */
  ...
  //struct cluster_with_sector_side_residuals_minimum cluster_residuals_array[48];
    ...
    uint8_t m_adc_information[48];
    uint8_t m_flags[48];

  ClassDefOverride(SvtxTrackArray_v5, 1);
};
